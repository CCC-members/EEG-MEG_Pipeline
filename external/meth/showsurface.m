...
% para.mymarkersize  size of dots (also for BESA-style dipoles). Default is 30.
...
% para.fixedcolors   if you have more than one source with size Kx1 (see
%                    below) for K surface nodes, then the second to last of
%                    these fields have a fixed color for all values not
%                    equal to zero (zeros are not shown at all). 
%                    You can specify the colors by 1x3 vectors in RGB scale
%                    or strings. E.g. fixedcolors{1}=[.5,.5,.5] and fixecolors{2}='k' sets the
%                    first color to gray and the second to black. This also
%                    the default. 

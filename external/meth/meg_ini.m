...
% do this once for given volume conductor and sensor 
% configuration. Note, that for 4 arguments all channels are magnetometers. 
% 
% input: 
...
function [coeffs,scale]=getcoeffs(device,vc,center,order)

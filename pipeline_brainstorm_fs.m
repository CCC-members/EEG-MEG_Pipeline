function [Gain,OPTIONS]=pipeline_brainstorm_fs(MriFile,electrodPos, nVerticesCortex,resamplingMethod,erodeFactor,fillFactor,...
                                        headVertices, isEEG, SnrFixed,NoiseReg,conductivity, showFigure, FileFormat)

    load(electrodPos);
    elect = [Channel.Loc]';

   [Gain,OPTIONS]= pipeline_brainstorm_gain(MriFile,elect, nVerticesCortex,resamplingMethod,erodeFactor,fillFactor,headVertices, isEEG, SnrFixed,NoiseReg,conductivity, showFigure,FileFormat);

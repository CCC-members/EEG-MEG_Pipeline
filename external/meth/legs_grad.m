function gradbasis=legs_grad(x,dir,n,scale)
% usage: gradbasis=legs_grad(x,dir,n,scale)
%
...
%
% output:   gradbasis: Nx((n+1)^2-1) matrix containing in the j.th row the scalar 
%                     product of the gradient of the former with the j.th row of dir
%
%                 the basis is  Nx((n+1)^2-1)  matrix containing in the j.th  row the real 
